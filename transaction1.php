...
$query_b = mysql_query("SELECT sum(`amount`) FROM `buy` WHERE `username`='".$_SESSION['username']."' and `stock`='".$stock."' AND `success`='1'");
$query_s = mysql_query("SELECT sum(`amount`) FROM `sell` WHERE `username`='".$_SESSION['username']."' and `stock`='".$stock."'");
...
if (isset($_POST['type']) && isset($_POST['stock']) && isset($_POST['value']) && isset($_POST['amount']) && (mysql_escape_string(trim($_POST['type']!=''))) && (mysql_escape_string(trim($_POST['stock']!=''))) && (mysql_escape_string(trim($_POST['value'] !=''))) && (mysql_escape_string(trim($_POST['amount']!=''))))
{
include "db.php";
...
$error = 'There was an error placing your order. You can retry placing the order, or you ca conatct us.';
}
}
