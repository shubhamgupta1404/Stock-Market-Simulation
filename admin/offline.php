<?php
if (isset($_POST['off']) && ($_POST['off']=="yes")) {
           $myFile = "off.php";
           $fh = fopen($myFile, 'w') or die("can't open file");
           
           $stringData = "<?php\n\$offline_message='".$_POST['elm1']."';\nheader('location: off.php');\n?>";
           fwrite($fh, $stringData);
           fclose($fh);
     }
if (isset($_POST['off']) && ($_POST['off']=="no")) {
           $myFile = "off.php";
           $fh = fopen($myFile, 'w') or die("can't open file");
...
<form action="index.php?option=offline" method="post" name="Form" id="user-form" class="form-validate">
	<div class="width-60 fltlft">
		...
		<fieldset class="adminform">
			...
			<ul class="adminformlist">
							<p><li>
							<label id="jform_username-lbl" for="jform_username" class="hasTip">Offline #</label>
							<?php 
							 
							    echo "<select id='off' name='off'  class='inputbox'>";
