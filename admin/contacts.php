...
if (isset($_POST['elm1']))
{
if (mysql_query("UPDATE `extra` SET `info` = '".$_POST['elm1']."' WHERE `extra`.`page` = 'contacts'")) echo "Successfully Updated";
else echo "Error!";
}
?>
...
<form method="post" action="index.php?option=contacts">
	<div>
		<?php
			$data = mysql_query("SELECT * FROM `extra` WHERE `page`='contacts'");
