...
<div id="content">
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<?php
			echo "<form id='formElem' name='formElem' action='transaction.php' method='post'>";
            ...
            <input type='hidden' name='type' id='hiddenField' value='BUY' />
		...
		<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td valign="top">
			<button id="registerButton" type="submit" class="form-submit" >Buy</button>
