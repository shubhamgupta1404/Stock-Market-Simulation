...
<div id="page-heading"><h1>Welcome</h1></div>
...
<tr>
	...
	<!--<h2>We have sent you a mail at your registered e-mail address.<br />-->
	Thanks for creating an account. Your Password is: <?php echo $_GET['p']; ?> Change your password after logging in.<br /><br />
	</h2> <a href="login.php">Click here to login.</a>
	<!-- end id-form  -->
